...
function add_invisible_ai_section($course, $name = '', $summary = '') {
    global $DB;
...
//    $section->summaryformat = 99; // This will identify the section as belonging to the Assessment Information block
//    $section->sequence = 666; // the number of the beast as we are misusing the sequence here...
    $DB->update_record('course_sections', $section);
    return $section;
}

// Only add the section if it does not alredy exist
$sql = "
select * 
...
$ai_section = reset($result);
if (!$ai_section) {
    $ai_section = add_invisible_ai_section($COURSE, "Generated by Assessment Information block", "");
   ...
   public function renderAssign($instanceid,$currentuserroleid,$cmid,$html){
    ...
    public function get_resources_list($resources, $section){
        ...
        if($count_section > 0){
            ...
            $sql='update {course_sections} set section='.$nextsection.',name="Generated by Assessment Information block" where section= '.TOPIC_ZERO_SECTION1.' and course = '.$COURSE->id;
