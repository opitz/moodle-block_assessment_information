...
$ai_section = reset($result); // get the 1st element of the returned array - should have one element only anyway
if (!$ai_section) {
    $ai_section = add_invisible_ai_section($COURSE, "Generated by Assessment Information block", $fo_content_assessmentinformation->value);
